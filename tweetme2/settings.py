...
TWEET_ACTION_OPTIONS = ["like", "unlike", "retweet", "delete", "reply"]
...
# ]
AUTH_USER_MODEL = 'accounts.UserRegisterDetails'
...
GOOGLE_RECAPTCHA_SECRET_KEY = '6LdLTIQbAAAAANajep8wV65i89L38eRtPlZ6vjDJ'