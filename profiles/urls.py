...
from .views import my_wall_view, my_dashboard_view, profile_update_view, trends_view , user_wall_view, show_more_view, search_users, search_clacks, search_trends, report_adverse_effect_form_view
...
urlpatterns = [
    ...
    path('dashboard/<str:username>', my_dashboard_view),
